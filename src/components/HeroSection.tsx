    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
        ...
        >
          ...
          <span className="text-gold-gradient italic">avec élégance</span>
        </motion.h1>
        ...
        >
          ...
          Des expériences immersives, uniques et inoubliables vous attendent.
        </motion.p>
        ...
        >
          <Button
            ...
            className="rounded-full px-10 py-6 text-base font-body tracking-wide"
          >
